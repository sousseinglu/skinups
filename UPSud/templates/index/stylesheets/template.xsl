...
<!-- Sur la page d'accueil, la toolbar est affichée dans la colonne de droite, pas dans l'en-tête -->
	...
	<xsl:template name="toolbar_fr">
		<div id="toolbar">
			<ul>
				...
				<li id="intranet"><a href="http://portail.u-psud.fr/" onClick="_gaq.push(['_trackPageview', '/ent']);">ENT / Intranet</a></li>
			</ul>
	...
	<xsl:template name="toolbar_en">
		<div id="toolbar">
			<ul>
				<li id="annuaire"><a href="http://www.annuaire.u-psud.fr/" onClick="_gaq.push(['_trackPageview', '/adonis']);">Directory</a></li>
                <!-- Lien Contact -->
                <xsl:if test="/cms/inputData/sitemap//page[@PLUGIN_TAGS_TOP_LINKS_CONTACT]">
                    <li id="contacts">
                        <a href="{$cms-context}/{$lang}/{/cms/inputData/sitemap//page[@PLUGIN_TAGS_TOP_LINKS_CONTACT]/@sitemap:path}.html">
        ...
        <xsl:if test="/cms/inputData/PageModel/composantes/page">     		
            <div id="composantes">
                ...
                <xsl:if test="$lang='en' or $lang='es'">
                    ...
                    <xsl:for-each select="/cms/inputData/sitemap//page[@PLUGIN_TAGS_COMPOSANTE]">
                        <li>
                            <a href="{$cms-context}/{$lang}/{@sitemap:path}.html" title="{$sitemap-goto-page} {@sitemap:title}"><xsl:value-of select="@sitemap:title" /></a>
                        </li>
                    </xsl:for-each>            
