...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
			...
			<tr>
				<td valign="top" align="right">
					<table height="37" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="30"><a href="{$cms-context}/fr/index.html"><img src="{$skincontext}/img/top_fr.gif" width="24" border="0" height="37"/></a></td>
							<td width="30"><a href="{$cms-context}/en/index.html"><img src="{$skincontext}/img/top_en.gif" width="24" border="0" height="37"/></a></td>
	...
	<xsl:template name="piwik">
		...
		var pkBaseURL = (("https:" == document.location.protocol) ? "https://stat.di.u-psud.fr/" : "http://stat.di.u-psud.fr/");
		...
		<noscript>
			<p><img src="http://stat.di.u-psud.fr/piwik.php?idsite=3" style="border:0" alt="" /></p>
		</noscript>
	</xsl:template>
	...
	<xsl:template name="google">
		<script type="text/javascript">
		  ...
		  var _gaq = _gaq || [];
		  _gaq.push(['_setAccount', 'UA-1379301-1']);
		...
		<script type="text/javascript"> <!--  cf https://support.google.com/analytics/bin/answer.py?hl=fr&answer=1136920&topic=1136919&ctx=topic	-->
